...
pairs_professional = [
    ...
    [
        "(.*)" + s_acc + "(.*)" + s_con + "(.*)",
        [
            "会计的概念：会计是以货币为主要计量单位，通过确认、计量、记录和报告等环节，反映特定会计主体的\n"
            "经济活动，向有关各方提供会计信息。会计核算是会计的首要职能。"
        ]
    ],
    [
        "(.*)" + s_acc + "(.*)" + s_bas_ch + "(.*)",
        [
            "会计的基本特征：会计是以货币为主要计量单位，通过确认、计量、记录和报告等环节，反映特定会计主体的\n"
            "经济活动，向有关各方提供会计信息。会计核算是会计的首要职能。"
        ]
    ],
    [
    ...
    [
        "(.*)" + s_mic + "(.*)" + s_eco + "(.*)" + s_mean + "(.*)",
        [
            "微观经济学主要以单个经济单位（单个的生产者、单个的消费者、单个市场的经济活动）作为研究对象。"
        ]
    ],
    [
        "(.*)" + s_mac + "(.*)" + s_eco + "(.*)" + s_mean + "(.*)",
        [
            "宏观经济学是使用国民收入、经济整体的投资和消费等总体性的统计概念来分析经济运行规律\n"
            "的一个经济学领域。"
        ]
    ],
    [
